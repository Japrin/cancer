...
parser$add_argument("-g", "--gfeature", default="/DBS/DB_temp/zhangLab/broad/bundle/2.8/hg19/gmap-gsnap/hg19.knownGene.RData", help="RData contains gene feature [default %(default)s]")
...
plot.geneNumber.saturation <- function(ds.res,note="RPKM")
{
    ...
    for(i in c(0,0.1,1,2,3,5,10,50,100,500))
    {
