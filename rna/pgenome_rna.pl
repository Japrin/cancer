...
sub aln
{
	...
	my $aJob={
		...
		project=>"mem",
		cpuNum=>8,
		cmd=>["$Bin/rna_HTSeqGenie.sh $outDir/HTSeqGenie $mergedFq1 $mergedFq2 $ID unknown unknown"],
		out=>["$outDir/HTSeqGenie/bams/$ID.analyzed.bam","$outDir/HTSeqGenie/results/$ID.counts_gene.tab","$outDir/HTSeqGenie/results/$ID.variants.vcf.gz"],
	};
