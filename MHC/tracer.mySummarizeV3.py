...
def get_cells_component(cells, sample_id):
    ...
    print "Cell_Name\tClonotype_ID\tComponent_Size" + \
        ...
        "\tIdentifier(Gamma1)\tCDR3(Gamma1)\tCDR3nt(Gamma1)\tVDJ(Gamma1)\tTPM(Gamma1)\tProductive(Gamma1)\tIn_Frame(Gamma1)\tStop_Codon(Gamma1)" + \
        "\tIdentifier(Gamma2)\tCDR3(Gamma2)\tCDR3nt(Gamma2)\tVDJ(Gamma2)\tTPM(Gamma2)\tProductive(Gamma2)\tIn_Frame(Gamma2)\tStop_Codon(Gamma2)" + \
        "\tIdentifier(Delta1)\tCDR3(Delta1)\tCDR3nt(Delta1)\tVDJ(Delta1)\tTPM(Delta1)\tProductive(Delta1)\tIn_Frame(Delta1)\tStop_Codon(Delta1)" + \
        "\tIdentifier(Delta2)\tCDR3(Delta2)\tCDR3nt(Delta2)\tVDJ(Delta2)\tTPM(Delta2)\tProductive(Delta2)\tIn_Frame(Delta2)\tStop_Codon(Delta2)"
